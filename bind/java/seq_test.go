...
import (
	...
	"github.com/mixinnetwork/mobile/internal/importers/java"
	"github.com/mixinnetwork/mobile/internal/sdkpath"
)
...
func TestClasses(t *testing.T) {
	...
	runTest(t, []string{
		"github.com/mixinnetwork/mobile/bind/testdata/testpkg/javapkg",
	}, "", "ClassesTest")
}
...
func TestJavaSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/mixinnetwork/mobile/bind/testdata/benchmark"}, "", "SeqBench")
}
