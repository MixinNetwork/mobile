...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/mixinnetwork/mobile/example/basic"})
	oldTags := buildTags
...
func TestRegexImportGolangXPackage(t *testing.T) {
	tests := []struct {
		...
		{"ffffffff t golang.org/x/mobile", "github.com/mixinnetwork/mobile", 2},
		{"ffffffff t github.com/example/repo/vendor/golang.org/x/mobile", "github.com/mixinnetwork/mobile", 2},
		...
		{"ffffffff t _golang.org/x/mobile/app", "github.com/mixinnetwork/mobile/app", 2},
	}
...
func TestBuildWithGoModules(t *testing.T) {
	...
	if out, err := exec.Command("go", "build", "-o="+dir, "github.com/mixinnetwork/mobile/cmd/gomobile").CombinedOutput(); err != nil {
	...
	for _, target := range []string{"android", "ios"} {
		t.Run(target, func(t *testing.T) {
			...
			tests := []struct {
				...
				{
					Name: "Absolute Path",
					Path: "github.com/mixinnetwork/mobile/example/basic",
				},
				{
					Name: "Relative Path",
					Path: "./example/basic",
